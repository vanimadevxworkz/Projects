     ...
     width="45" height="45">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="index.jsp" style="color:red">Home</a>
					</li>
				</ul>
			</div>
		</div>
...
<div class="container">
    <form action="submit">     
        <h3 style="color:blue">Apply Here.....</h3>
        <div class="design">
        <div class="design">
        ...
        <span id="alteNumberError" style="color: red;"></span>
		</div>
       
        <div class="design">
          <div class="design">
            <label for="inputPlace">Present place</label>
        <input type="text" class="form-control" id="inputPlace" placeholder=" place name" name="enterPlace" required>
          </div>
          ...
          <div class="design">
            ...
            <input type="number" class="form-control" id="inputAge" placeholder="Enter city name" onblur="validateNumber()" required>
         <span id="ageError"> </span>
          ...
          <div class="design">
            ...
            <select id="inputState" class="form-control" name="enterCountry" required>
          ...
          <div class="design">
            ...
            <select id="inputState" class="form-control" name="enterState" required>
              ...
              <option value="Bihar">Biha r</option>
         ...
         <button type="submit" class="btn btn-success" href="success.jsp" id="button" disabled="disbled">Submit</button>
